...
```json
{
  "weeklyAnalytics": {
    ...
    "emotionalMetrics": {
      "dailyMoodScores": [
        {"date": "2024-01-21", "moodScore": 3},
        {"date": "2024-01-27", "moodScore": 4}
      ],
...
```json
{
  "monthlyAnalytics": {
    ...
    "weightProgress": {
      ...
      "endWeight": 84.8,
      "weightLoss": 3.7,
      "weightLossPercentage": 4.18,
      "averageWeeklyLoss": 0.925,
      "targetWeight": 80.0,
      "progressToTarget": 54.6
    },
    ...
    "insights": [
      {
        "type": "positive",
        "title": "تحسن واضح جداً",
        "description": "نسبة الالتزام تحسنت من 58% إلى 76% خلال الشهر"
      }
    ],
...
## 🍽️ FoodItems & Meals Database (قاعدة البيانات الكاملة)

```json
{
  "foodDatabase": {
    "dietSystem": "Al-Tayebat System",
    "version": "1.0",
    "totalItems": 45,
    ...
    "foodItems": [
      {
        "id": 1,
        "arabicName": "توست بردة",
        "englishName": "Bran Toast",
        "category": "carbs",
        "isAllowed": true,
        "frequency": "daily",
        "image": "https://cdn.taybat.app/foods/bran-toast.jpg"
      },
      {
        "id": 2,
      ...
      },
      {
        ...
        "isAllowed": true,
        "frequency": "daily",
        "image": "https://cdn.taybat.app/foods/rice.jpg"
      },
      {
        "id": 29,
        "arabicName": "لحمة",
        ...
        "isAllowed": true,
        "frequency": "up_to_3_times_weekly",
        "image": "https://cdn.taybat.app/foods/meat.jpg"
      }
    ],
    
    "mealOptions": [
      {
        "mealId": "breakfast-001",
        "arabicName": "توست مع زيت وجبن",
        "englishName": "Bran Toast with Oil and Cheese",
        "category": "breakfast",
        "itemIds": [1, 2, 3],
        "arabicDescription": "توست مع رده وزيت زيتون وجبن مسموحه",
        "englishDescription": "Bran toast with olive oil and allowed cheese",
        "estimatedCalories": 350,
        "preparationTime": 5,
        "difficulty": "easy",
        "image": "https://cdn.taybat.app/meals/breakfast-001.jpg"
      },
      {
        "mealId": "lunch-001",
        "arabicName": "أرز مع لحم والشوربة",
        "englishName": "Rice with Meat and Soup",
        "category": "lunch",
        "itemIds": [27, 28, 29],
        "arabicDescription": "أرز وشوربه ولحمه",
        "englishDescription": "Rice, soup and meat",
        "estimatedCalories": 650,
        "preparationTime": 45,
        "difficulty": "medium",
        "image": "https://cdn.taybat.app/meals/lunch-001.jpg"
      }
    ]
  }
}
